...
Reply in ${getCurrentLanguageName()}` : ""),
  ...
  var Footer = () => /* @__PURE__ */ h("div", { className: "wcg-flex wcg-flex-col wcg-items-center wcg-p-4" }, /* @__PURE__ */ h("p", { style: { whiteSpace: "pre-line" }, className: "wcg-m-0 wcg-p-1 wcg-text-center wcg-text-lg" }, getTranslation(localizationKeys.UI.supportMe)), /* @__PURE__ */ h("div", { className: "wcg-flex wcg-flex-row wcg-items-center wcg-gap-4" }, /* @__PURE__ */ h("a", { className: "wcg-p-4", href: "https://www.buymeacoffee.com/anzorq?utm_source=webchatgpt&utm_medium=options_page", target: "_blank", rel: "noopener noreferrer" }, /* @__PURE__ */ h("img", { src: "https://img.buymeacoffee.com/button-api/?text=Support this project&slug=anzorq&button_colour=FFDD00&font_colour=000000&font_family=Poppins&outline_colour=000000&coffee_colour=ffffff", alt: "Buy Me A Coffee" })), /* @__PURE__ */ h("a", { className: "wcg-p-4", href: "https://chrome.google.com/webstore/detail/webchatgpt-chatgpt-with-i/lpfemeioodjbpieminkklglpmhlngfcn/reviews", target: "_blank", rel: "noopener noreferrer" }, /* @__PURE__ */ h("img", { src: "../leave_review.png", alt: "Review on Chrome Web Store", className: "wcg-h-[4.25em] wcg-rounded-lg" }))));
