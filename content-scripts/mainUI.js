...
(() => {
  ...
  var compilePrompt = async (results, query2) => {
    const currentPrompt = await getCurrentPrompt();
...
Reply in ${getCurrentLanguageName()}` : ""),
  ...
  function Footer() {
    const extension_version = import_webextension_polyfill4.default.runtime.getManifest().version;
    return /* @__PURE__ */ h("div", { className: "wcg-text-center wcg-text-xs wcg-text-gray-400" }, /* @__PURE__ */ h("a", { href: "https://github.com/qunash/chatgpt-advanced", target: "_blank", className: "underline wcg-text-gray-400 wcg-underline", rel: "noreferrer noopener" }, "WebChatGPT extension v.", extension_version), ". If you like the extension, please consider ", /* @__PURE__ */ h("a", { href: "https://www.buymeacoffee.com/anzorq?utm_source=webchatgpt&utm_medium=toolbar", target: "_blank", className: "wcg-text-gray-400 wcg-underline", rel: "noreferrer noopener" }, "supporting me"), ".");
  }
  ...
  var Toolbar = ({ textarea: textarea2 }) => {
    ...
    h2(() => {
      ...
      import_webextension_polyfill5.default.runtime.onMessage.addListener(handleMessage);
      return () => import_webextension_polyfill5.default.runtime.onMessage.removeListener(handleMessage);
    }, []);
    h2(() => {
    ...
    const handlePromptChange = (e3) => {
      ...
      if (uuid === "wcg-new-prompt") {
        import_webextension_polyfill5.default.runtime.sendMessage("show_options");
    ...
    const webAccessToggle = /* @__PURE__ */ h("div", { className: "wcg-group wcg-relative wcg-flex" }, /* @__PURE__ */ h("label", { className: "wcg-relative wcg-inline-flex wcg-cursor-pointer wcg-items-center" }, /* @__PURE__ */ h("input", { type: "checkbox", value: "", className: "wcg-peer wcg-sr-only", checked: webAccess, onChange: handleWebAccessToggle, title: "Web access" }), /* @__PURE__ */ h("div", { className: "wcg-peer wcg-h-5 wcg-w-9 wcg-rounded-full wcg-bg-gray-500 after:wcg-absolute after:wcg-top-[2px] after:wcg-left-[2px] after:wcg-h-4 after:wcg-w-4 after:wcg-rounded-full after:wcg-border after:wcg-border-gray-300 after:wcg-bg-white after:wcg-transition-all after:wcg-content-[''] peer-checked:wcg-bg-emerald-700 peer-checked:after:wcg-translate-x-full peer-checked:after:wcg-border-white peer-focus:wcg-ring-2 peer-focus:wcg-ring-white dark:wcg-border-gray-600" }), /* @__PURE__ */ h(
      "span",
      {
    ...
    )), /* @__PURE__ */ h("span", { class: "wcg-absolute wcg-left-1/2 wcg-m-4 wcg-mx-auto -wcg-translate-x-6 wcg-translate-y-3 wcg-rounded-md wcg-bg-gray-800 wcg-p-1 \r\n            wcg-text-xs wcg-text-gray-100 wcg-opacity-0 wcg-transition-opacity group-hover:wcg-opacity-100" }, "Alt+W"));
    return /* @__PURE__ */ h("div", { className: "wcg-flex wcg-flex-col wcg-gap-0" }, /* @__PURE__ */ h("div", { className: "wcg-toolbar wcg-flex wcg-items-center wcg-gap-2 wcg-rounded-md wcg-px-1" }, /* @__PURE__ */ h(
      "div",
      {
        ...
        tabIndex: 0,
        onClick: () => import_webextension_polyfill5.default.runtime.sendMessage("show_options")
      },
      icons.tune
    ), webAccessToggle, /* @__PURE__ */ h("div", { class: "wcg-scrollbar-hidden wcg-flex wcg-items-center wcg-justify-between wcg-gap-2 wcg-overflow-x-scroll wcg-px-1 lg:wcg-overflow-x-hidden" }, /* @__PURE__ */ h(
      dropdown_default,
      {
        value: numResults,
    ...
    ))), /* @__PURE__ */ h(footer_default, null));
  };
...
${rightPanelInfoText}` : ""}`,
  ...
  async function webSearch(search, numResults) {
    const response = await import_webextension_polyfill6.default.runtime.sendMessage({
    ...
    if (response.url.startsWith(BASE_URL)) {
      ...
      const result = await import_webextension_polyfill6.default.runtime.sendMessage({
  ...
  async function createShadowRoot(pathToCSS) {
    ...
    style.textContent = await fetch(import_webextension_polyfill7.default.runtime.getURL(pathToCSS)).then((response) => response.text());
  ...
  async function apiExtractText(url) {
    const response = await import_webextension_polyfill8.default.runtime.sendMessage({
      type: "get_webpage_text",
      url
    });
    return [response];
